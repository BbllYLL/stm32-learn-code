...
uint8_t MPU6050_ReadReg(uint8_t RegAddress)
{
	...
	I2C_Send7bitAddress(I2C2,MPU6050_ADDRESS,I2C_Direction_Transmitter);
	MPU6050_WaitEvent(I2C2,I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED);	//EV6_TRANSMITTER
	...
	MPU6050_WaitEvent(I2C2,I2C_EVENT_MASTER_RECEIVER_MODE_SELECTED);	//EV6_RECEIVER

	I2C_AcknowledgeConfig(I2C2,DISABLE);	//EV6_1
	I2C_GenerateSTOP(I2C2,ENABLE);			//EV6_1
