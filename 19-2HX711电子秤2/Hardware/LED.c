...
void LED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13 | GPIO_Pin_14;  //PC13  PC14
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOC, &GPIO_InitStructure);						//将PC13和PC14引脚初始化为推挽输出
	              //GPIOC
	/*设置GPIO初始化后的默认电平*/
	GPIO_SetBits(GPIOC, GPIO_Pin_13 | GPIO_Pin_14);				//设置PC13和PC14引脚为高电平
}                 //GPIOC
